...
namespace Drill_Page_232_MVC.Models
{
    public class Calculation
    {
        ...
        public string CalculateQuote(string firstName, string lastName, string emailAddress, DateTime dateOfBirth, 
                                        string carYear, string carMake, string carModel, string duiStatus, int speedingTicketNum, string typeOfCoverage)
        {
            decimal quote = 50m;
            ...
            if (duiStatus == "Yes") { quote *= Convert.ToDecimal(1.25); }
